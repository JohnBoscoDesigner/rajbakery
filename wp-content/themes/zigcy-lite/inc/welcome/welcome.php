						...
						<div class="zigcy-column-wrap">
							<div class="zigcy-column col-demos">
								...
								<div>
									...
									<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'zigcy-lite' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?>

									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'zigcy-lite' ); ?></p>
									<a href="https://accesspressthemes.com/support/" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'zigcy-lite' ); ?></span></a>
							...
							<div class="zigcy-column col-doc">
								...
								<div class="zigcy-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'zigcy-lite' ); ?></span></a>
								</div>
							</div>
							</div>
						</div>
